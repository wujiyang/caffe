...
%% caffe setttings
matCaffe = fullfile(pwd, '../../caffe/matlab');
...
model   = '/home/wujiyang/Local_Face/caffe/face_example/ResNet50_SphereFace/ResNet50_SphereFace_Test.prototxt';
weights = '/home/wujiyang/Local_Face/caffe/face_example/ResNet50_SphereFace/SnapShot/quadruple/vggface2_quadruple_iter_120000.caffemodel';
net     = caffe.Net(model, weights, 'test');
net.save('result/sphereface_model.caffemodel');

%% compute features
pairs = parseList('data/pairs.txt', fullfile(pwd, 'data/lfw-224X224'));
